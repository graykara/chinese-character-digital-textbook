    ...
    <>
      <div className="animate__animated animate__fadeIn relative pb-[30px]">
        ...
        {className ? (
          ...
          <li className={`absolute top-[177px] left-[200px] ${className} leading-tight max-w-[1400px] break-keep `}>
            {title}
          </li>
        </ul>
        ) : (
          <ul className="list-disc marker:text-[#567c56] pl-3">
          <li className={`-mt-[40px] ml-[180px] text-[55px] leading-tight tracking-tighter max-w-[1400px] break-keep`}>
            {title}
          </li>
        </ul>
        )}
