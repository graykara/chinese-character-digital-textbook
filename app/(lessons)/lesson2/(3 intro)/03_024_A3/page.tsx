...
export default function Page() {
  ...
  return (
    <>
      ...
      <IntroWhatHeader className="absolute right-[100px] top-[100px]" />

      <div className="bg-white bg-opacity-50 absolute right-[100px] top-[250px] w-[1100px] h-[670px] overflow-y-auto rounded-[20px] p-[25px]">
        <IntroTextPlayer
