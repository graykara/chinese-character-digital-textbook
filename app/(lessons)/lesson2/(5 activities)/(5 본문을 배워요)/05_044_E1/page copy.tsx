  ...
  const data = [
    {
      ...
      content: (
        <div className="flex text-[50px] w-[450px] tracking-tighter font-bold bg-slate-600">
          안부를{" "}
          <FlippableCard
            active={showMeaning}
    ...
    },
    {
      ...
      reading: "무 난",
      content: (
        <div className="w-[300px] items-center flex-wrap text-[50px] tracking-tighter font-bold">
          어려움이{" "}
          <FlippableCard
            active={showMeaning2}
            className="mx-5 inline-block"
    ...
    <>
      <LearnMainContentPageTemplate>
        ...
        {/* {step === 1 ? (
          ...
          <ContentContainer className="w-[1300px] h-full grid grid-cols-2 px-20">
            <div className="relative top-6">
              <div className="relative left-[135px] w-[550px] h-[220px] text-center text-[180px] tracking-widest">
              ...
              <div className="flex flex-col gap-16 mt-10">
                ...
                <div className="relative grid grid-cols-[180px__300px] bg-slate-200">
                  <PillButton
                    active={showMeaning}
            ...
            <div key={step}>
              ...
              <div className="absolute right-0 w-[1000px] h-[115px]">
                <div>
                  <img src={data[step - 1]?.resource} alt="resource" className="absolute bottom-16 right-10"/> 
