              ...
              <FlippableCard
                ...
                text={
                  ...
                  <p className="text-[30px] leading-[35px] tracking-[-2.5px] break-keep mt-1">
                    합해와 달은 하늘 높이 떠있는 것이므로, 둘을 합치면 ‘아주 높은 지위’를 의미하지 않을까?
                    </p>
                  </>
                }
                ...
                // frontClassName="!bg-[#daecf2] outline-[10px] outline outline-[#daecf2] outline-offset-[8px] !border-transparent !rounded-2xl"
                // backClassName="!bg-[#daecf2] outline-[10px] outline outline-[#daecf2] outline-offset-[8px] !border-transparent !rounded-2xl"
                // contentClassName="text-example text-[25px]"
              />
            </div>
          )}
              ...
              <FlippableCard
                ...
                text={
                  ...
                  <p className="text-[30px] leading-[35px] tracking-[-2px] break-keep mt-1">
                    나무에, 나무에 또 나무가 더해진다? 나무가 빽빽하게 들어선 모습이 떠오르네.
                    </p>
                  </>
                }
