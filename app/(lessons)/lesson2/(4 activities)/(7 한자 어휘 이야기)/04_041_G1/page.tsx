        ...
        <>
          ...
          <ContentContainer>
            <div className="relative -top-[5px] w-[1460px]">
              ...
              >
                ‘넓고 큰 바다’를 ‘<span className="font-haeseo text-[60px] leading-tight">海洋</span>’이라고 일컫는다. 여기서 ‘
                <span className="font-haeseo text-[60px] leading-tight">海</span>’와 ‘
                <span className="font-haeseo text-[60px] leading-tight">洋</span>’
                <br />
                모두 바다를 뜻하지만, 그 쓰임에는 차이가 있다. 동해, 서해,
                <br />
                지중해 등의 용례에서 확인되듯이 ‘~
                <span className="font-haeseo text-[60px] leading-tight">海</span>’는 육지와 접해 있는 <br />
                바다를 가리킬 때 사용하고, ‘~
                <span className="font-haeseo text-[60px] leading-tight">洋</span>’은 태평양, 대서양, 인도양
                <br />
