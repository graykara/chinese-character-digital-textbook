      ...
      <ContentContainer>
        {step === 1 && (
          <div className="absolute top-[105px] w-[1460px]">
            <div
              className={`bg-[#f4ede1] rounded-[50px] px-20 py-[100px] -mt-4 text-[55px] leading-[85px] tracking-tight break-keep transition-colors duration-[2000ms] ${isReading ? "text-reading" : ""
                }`}
            >
              한·중·일 삼국은 지리적으로 매우 가깝고 ‘한자 문화권’이라는 공통점이 있는 만큼 성어를 사용하는 문화 역시 비슷하다.
              <br />다만 각 나라의 문화적 특성, 한자 사용의 차이에 따라 성어를 표현하는 방식이 다르게 나타나기도 한다. 이는 ‘결심이 굳지 못 함.’을 뜻하는 성어에서도 확인해 볼 수 있다.
            </div>
          </div>
        )}
        {step === 2 && (
