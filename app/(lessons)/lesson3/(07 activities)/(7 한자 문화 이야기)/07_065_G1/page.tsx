...
const Step1 = () => {
  ...
  [
    { text: "중국 춘추 시대에 손양(孫陽)이라는 사람은 千里馬 (천리마)를 알아보는 재주를 가졌기에, 옥황상제의 天馬 (천마)를 관장하는 자리의 이름인 ‘백락(伯樂)’으로 불렸다.", start: 0, end: 11222 },
    { text: "그는 병에 걸려 털이 빠지고 삐쩍 마른 말에게서도 숨은 능력과 자질을 알아보는 뛰어난 안목을 가지고 있었다.", start: 11222, end: 19600 },
    { text: "훗날 그와 관련하여 “세상에 백락이 있고 나서야 천리마가 있는 것이다.", start: 19600, end: 25536 },
    { text: "천리마는 항상 있지만, 백락은 항상 있는 것은 아니다.[한유, 『잡설(雜說)』]”라는 말이 남아 있을 정도다.", start: 25536, end: 31992 },
    { text: "이와 같은 백락의 안목은 지금도 여러 사람 중에 재주가 뛰어난 사람을 가려내는 능력으로 비유되기도 한다.", start: 31992, end: 40333 },
  ];
