...
export default function Page() {
  ...
  return (
    <>
      ...
      {/* <img src={BACKGROUND4.src} className="absolute left-0 top-0 opacity-25 pointer-events-none" /> */}
    </>
  );
}
    ...
    <>
      ...
      <ContentContainer>
        <div className="relative w-[1460px] -top-8">
          ...
          >
            중국 춘추 시대에 손양(<span className="font-haeseo">孫陽</span>)이라는 사람은 *<span className="font-haeseo">千里馬</span>(천리마)를 알아보는 재주를 가졌기에, 옥황상제의 *<span className="font-haeseo">天馬</span>
            (천마)를 관장하는 자리의 이름인 ‘백락(<span className="font-haeseo">伯樂</span>)’으로 불렸다. 그는 병에
            ...
            <span className="font-haeseo">雜說</span>)』]” 라는 말이 남아 있을 정도다.이와 같은 백락의 안목은 지금도 여러 사람 중에 재주가 뛰어난 사람을 가려내는 능력으로 비유되기도 한다.
          </div>
        </div>
      </ContentContainer>
    </>
