...
const Step1 = () => {
  ...
  [
    ...
    {
      text: "정조는 신분과 당파에 관계없이 문예와 학식이 뛰어난 이를 규장각 실무자로 선발하였는데, “천하에는 하나의 재능도 없는 사람은 없으니 만약 많은 사람을 모아 각각 그의 장점을 써서 재능을 서로 통용하게 한다면, 세상에는 버려진 사람이 없을 것이고 사람은 재능을 버리는 일이 없을 것이다.”라는 신념을 가지고 있었기 때문이다.",
      start: 7950,
      end: 32780,
    },
    {
      text: "당시 서자라는 신분적 한계에도 규장각을 통해 재능을 펼친 학자로는 이덕무, 유득공, 박제가 등이 있다.",
      start: 32780,
      end: 42762,
    },
  ];
