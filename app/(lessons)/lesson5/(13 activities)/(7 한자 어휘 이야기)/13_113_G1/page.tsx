...
export default function Page() {
  ...
  [
    { text: "조선 초기의 문신 황희는 우의정, 좌의정, 영의정 등 최고의 벼슬을 두루 거쳤기에 황희 정승이라 불린다.", start: 0, end: 10110 },
    { text: "세종 때에는 무려 18년간 영의정으로 재임하였다.", start: 10110, end: 14510 },
    { text: "어느 눈 내리는 겨울날, 황희 정승의 단벌 관복의 솜을 뜯어내어 빨래하고 있는데 갑자기 입궐하라는 소식이 왔다.", start: 14510, end: 23930 },
    { text: "황희는 급히 얼기설기 솜을 꿰맨 관복을 입고 궁에 들어가게 되었다.", start: 23930, end: 30458 },
  ]; 
  [
    { text: "솜이 삐져나온 관복을 입은 황희의 모습을 본 세종이 그 이유를 듣고 한 나라의 재상이 어찌 관복 한 벌로 겨울을 나겠냐며 비단을 내리도록 하였다.", start: 0, end: 11866 },
    { text: "그러자 황희는 “지금 이 나라 백성들은 연이은 흉년에 헐벗고 굶주리고 있습니다. 그런데 어찌 정승으로서 몸에 비단을 걸치겠습니까? 이 솜옷 한 벌로 충분합니다.”라고 말하였다.", start: 11866, end: 25806 },
    { text: "이에 세종은 비단을 내리라는 명을 거두었다.", start: 25806, end: 30511 },
  ];
