...
export default function Page() {
  ...
  [
    ...
    {
      text: "그리고 최근에는 동물의 건강이나 안전 및 습성 존중 등 복지 요소를 강화하는 추세에 있다.",
      start: 9432,
      end: 17371,
    },
  ];
  [
    {
      text: "이는 수십 년에 걸쳐 반려동물을 키우는 가정이 크게 늘었으나 성숙한 동물 관리 문화가 정착되지 못하여 동물을 학대하거나 유기하는 등의 사례 또한 늘어 사회 문제가 되기 때문이다.",
      start: 0,
      end: 14206,
    },
    {
      text: "이뿐만 아니라 실험동물, 전시 동물, 야생 동물 등의 관리 및 처우 문제에 대한 대책도 필요한 만큼 동물 보호, 복지 관련 법 준수를 바탕으로 동물과 사람이 공존해야 한다는 사회적 인식이 필요하다.",
      start: 14206,
      end: 29988,
    },
  ];
        ...
        {step === 2 && (
          <div className="absolute top-[55px] w-[1460px]">
            ...
            >
              ...
              사례 또한 늘어 사회 문제가 되기 때문이다. 이뿐만 아니라 실험동물,
              전시 동물, 야생 동물 등의 관리 및 처우 문제에 대한 대책도 필요한
              만큼 동물 보호, 복지 관련 법 준수를 바탕으로 동물과 사람이
              공존해야 한다는 사회적 인식이 필요하다.
            </div>
          </div>
        )}
