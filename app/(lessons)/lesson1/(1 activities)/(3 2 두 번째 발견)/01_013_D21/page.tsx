    ...
    <>
      ...
      <div className="w-[1600px] h-full mx-auto flex flex-col justify-center items-center px-[150px] mb-[200px]">
        <div className="relative">
          ...
          />
          <div
            className={`border-8 rounded-[35px] border-[#e44d74] w-[1560px] text-[52px] px-9 py-12 leading-[72px] tracking-[-2px] break-keep animate__animated animate__fadeIn animate__delay-1s transition-colors duration-[2000ms] ${
